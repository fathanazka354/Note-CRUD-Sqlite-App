...
import com.fathan.projectjmp.db.DatabaseContract.NoteColumns.Companion.TABLE_NAME
...
internal class DatabaseHelper(context: Context): SQLiteOpenHelper(context, DATABASE_NAME,null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private const val SQL_CREATE_TABLE_NOTE = "CREATE TABLE $TABLE_NAME" +
                ...
                " ${DatabaseContract.NoteColumns.GENDER} BOOLEAN NOT NULL," +
                " ${DatabaseContract.NoteColumns.LOCATION} TEXT NOT NULL," +
                " ${DatabaseContract.NoteColumns.EMAIL} TEXT NOT NULL,"+
                " ${DatabaseContract.NoteColumns.IMAGE_URL} TEXT NOT NULL)"
    }
